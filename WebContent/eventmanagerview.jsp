...
<tr><td>DATE:</td><td><input type="date" name="eventdate"/></td></tr>
<tr><td>TIME:</td><td><input type="time" name="eventtime"/></td></tr>
<tr><td>WEBSITE:</td><td><input type="text" name="eventplace"/></td></tr>
